...
X_train, X_test, y_train, y_test, indices_train, indices_test = train_test_split(features, labels, data.articles, test_size=0.33, random_state=0)
...
texts = ["Put a list of texts here"]
...
#Saving the model (Final product)
dump(final_m, 'ML News Classifier.joblib')